# Deploy GROE v7 — Simple Procedure
...
1. Extract `GROE-Client-Feedback-v7-FULL.zip` on your computer.
...
6. Commit with: `Deploy complete GROE client feedback v7`.
7. Confirm these files exist on `main`:
   - `backend/app/static/index.html`
   - `backend/app/static/assets/app.v7.js`
   - `backend/app/static/assets/styles.v7.css`
...
```text
https://groe-fullstack-beta.onrender.com/assets/app.v7.js
```

It must return JavaScript rather than 404. The website footer must show `Beta build 7.0.0`.
